...
public class DatabaseConfig {
    ...
    public DataSource dataSource() {
        logger.info("[MERCHANDISE SERVICE] Verificando conexión a la base de datos MySQL...");
        
        if (testConnection(mysqlUrl, mysqlUsername, mysqlPassword)) {
            logger.info("[MERCHANDISE SERVICE] Conexión MySQL establecida exitosamente.");
            ...
            logger.warn("[MERCHANDISE SERVICE] MySQL no está disponible. Conmutando a SQLite local (Fallback)...");
            DriverManagerDataSource dataSource = new DriverManagerDataSource();
