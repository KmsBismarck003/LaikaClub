...
public class DatabaseConfig {
    ...
    public DataSource dataSource() {
        logger.info("[ANALYTICS SERVICE] Verificando conexión a la base de datos MySQL...");
        
        if (testConnection(mysqlUrl, mysqlUsername, mysqlPassword)) {
            logger.info("[ANALYTICS SERVICE] Conexión MySQL establecida exitosamente.");
            ...
            logger.warn("[ANALYTICS SERVICE] MySQL no está disponible. Conmutando a SQLite local (Fallback)...");
            DriverManagerDataSource dataSource = new DriverManagerDataSource();
