...
public class DatabaseConfig {
    ...
    public DataSource dataSource() {
        logger.info("[ACHIEVEMENTS SERVICE] Verificando conexión a la base de datos MySQL...");
        
        if (testConnection(mysqlUrl, mysqlUsername, mysqlPassword)) {
            logger.info("[ACHIEVEMENTS SERVICE] Conexión MySQL establecida exitosamente.");
            ...
            logger.warn("[ACHIEVEMENTS SERVICE] MySQL no está disponible. Conmutando a SQLite local (Fallback)...");
            DriverManagerDataSource dataSource = new DriverManagerDataSource();
