...
import com.laikaclub.achievements.service.TokenService;
    ...
    protected void doFilterInternal(@org.springframework.lang.NonNull HttpServletRequest request,
        ...
        if (xUserId != null && !xUserId.trim().isEmpty()) {
            try {
                ...
                String role = (xUserRole != null && !xUserRole.trim().isEmpty()) ? xUserRole.trim() : "USER";
            ...
            if (authHeader != null && authHeader.startsWith("Bearer ")) {
                ...
                if (tokenService.validateToken(token)) {
                    ...
                    if (email != null && SecurityContextHolder.getContext().getAuthentication() == null) {
                        String cleanRole = role != null ? role.toUpperCase() : "USER";
