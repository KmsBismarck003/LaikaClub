...
public class DatabaseConfig {
    ...
    public DataSource dataSource() {
        logger.info("[ADMIN SERVICE] Verificando conexión a la base de datos MySQL...");
        
        if (testConnection(mysqlUrl, mysqlUsername, mysqlPassword)) {
            logger.info("[ADMIN SERVICE] Conexión MySQL establecida exitosamente.");
            ...
            logger.warn("[ADMIN SERVICE] MySQL no está disponible. Conmutando a SQLite local (Fallback)...");
            DriverManagerDataSource dataSource = new DriverManagerDataSource();
