...
public class DatabaseConfig {
    ...
    public DataSource dataSource() {
        logger.info("[AUTH SERVICE] Verificando conexión a la base de datos MySQL...");
        
        if (testConnection(mysqlUrl, mysqlUsername, mysqlPassword)) {
            logger.info("[AUTH SERVICE] Conexión MySQL establecida exitosamente.");
            ...
            logger.warn("[AUTH SERVICE] MySQL no está disponible. Conmutando a SQLite local (Fallback)...");
            DriverManagerDataSource dataSource = new DriverManagerDataSource();
