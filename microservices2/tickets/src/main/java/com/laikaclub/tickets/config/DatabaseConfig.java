...
public class DatabaseConfig {
    ...
    public DataSource dataSource() {
        logger.info("[TICKETS SERVICE] Verificando conexión a la base de datos MySQL...");
        
        if (testConnection(mysqlUrl, mysqlUsername, mysqlPassword)) {
            logger.info("[TICKETS SERVICE] Conexión MySQL establecida exitosamente.");
            ...
            logger.warn("[TICKETS SERVICE] MySQL no está disponible. Conmutando a SQLite local (Fallback)...");
            DriverManagerDataSource dataSource = new DriverManagerDataSource();
