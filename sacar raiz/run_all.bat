...
start cmd /k "title Microservicios && echo Iniciando Microservicios... && cd /d %~dp0 && call C:\Users\redja\miniconda3\Scripts\activate.bat laika2 && python run_microservices.py"
