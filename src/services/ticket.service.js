...
export const refundAPI = {
    checkPolicy: eventId => apiClient.get(`/tickets/refunds/policy/${eventId}`),
    requestRefund: (formData) =>
        apiClient.post('/tickets/refunds/request', formData),
    getMyRefunds: () => apiClient.get('/tickets/refunds/my-refunds')
}
